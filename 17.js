...
————————————————
入口：[ https://prodev.m.jd.com/mall/active/4Z1uG195nnXVofHyAfjpz5AcnFmw/index.html?_ts=1634953629528&ad_od=share&utm_user=plusmember&gx=RnEwlzZZbDbbmtQTq4J3WgZ0xKI&cu=true&utm_source=kong&utm_medium=jingfen&utm_campaign=t_1002070633_&utm_term=98cd9b77e8e24ef68f092bc95840bdd7#/]

*/
const $ = new Env('11.11视频会员');
...
async function run() {
  try {
    ...
    let config = [
      {configCode:'c884f4e473884217ad8fabcc160ecda0',configName:'食品会员'},
